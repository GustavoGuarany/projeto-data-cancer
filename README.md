...
<h2> Este projeto aplica técnicas de engenharia de dados para analisar e interpretar um vasto conjunto de dados disponível no site kaggle sobre o câncer no Brasil. </h2>
<br>
 ...
 * [Análise Exploratória](#analise)
    ...
    + [Faixa-etária de 45-54 anos](#45-54)<br>
    + [Faixa-etária de 55-64 anos](#55-64)<br>
    + [Mortes por estado](#estado)<br>
    + [Mortes por cidade](#cidade)<br>
...
<div id='faixa-etaria-diagnostico'/> 
...
<div id='morte-tipo-cancer'/> 

## Relação morte por câncer e tipo do câncer
